<?php $c_admin= $this->session->userdata('c_admin'); $admin= $this->M_admin->getadmin($c_admin); foreach($admin as $hadmin); ?>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="<?php echo base_url('admin/notifikasi'); ?>">Lihat Semua</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $hadmin->nama; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('admin/allpengajuan'); ?>"><i class="fa fa-circle-o"></i> Seluruh Data</a></li>
          </ul>
        </li>
        <li>
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <form id="form" method="post" action="<?php echo base_url('admin/keperbulan'); ?>" enctype="multipart/form-data">
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <form id="formpen" method="post" action="<?php echo base_url('admin/kepertanggal'); ?>" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-group">
        ...
        <div class="modal-footer">
          <button class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-ok"></i> Lanjutkan</button> 
          <a class="btn btn-default btn-sm" onclick="tutupen()"><i class="glyphicon glyphicon-remove"></i> Tutup</a>
        </div>
        </form>
    </div>
</div>
    ...
    <div class="modal-content">
        <div class="modal-header bg-primary">
          ...
          <div class="modal-body text-center">
            <a href="<?php echo base_url('admin/perstatus/approve'); ?>" class="btn btn-sm bg-blue"><i class="fa fa-check"></i> Approve</a>
            <a href="<?php echo base_url('admin/perstatus/pending'); ?>" class="btn btn-sm bg-green"><i class="fa fa-refresh"></i> Pending</a>
            <a href="<?php echo base_url('admin/perstatus/reject'); ?>" class="btn btn-sm bg-red"><i class="fa fa-circle-o"></i> Reject</a>
            <a href="<?php echo base_url('admin/perstatus/batal'); ?>" class="btn btn-sm bg-navy"><i class="fa fa-close"></i> Batal</a>
            <a href="<?php echo base_url('admin/perstatus/norespon'); ?>" class="btn btn-sm bg-orange"><i class="fa fa-info"></i> No Respon</a>
          </div>      
        <div class="modal-footer">
          <a class="btn btn-default btn-sm" onclick="tutupen()"><i class="glyphicon glyphicon-remove"></i> Tutup</a>
        </div>
