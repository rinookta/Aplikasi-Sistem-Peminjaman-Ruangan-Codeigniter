...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url('admin/login'); ?>" method="post">
      ...
      <button type="submit" name="submit" class="btn btn-lg btn-primary btn-block btn-flat" style="font-size: 15px;">Login Admin <i class="glyphicon glyphicon-log-in"></i></button>
    </form>
    <br>
