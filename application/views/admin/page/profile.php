	    	...
	    	<div class="box box-info">
	    		...
	    		<div class="box-body table-responsive">
	    			<form id="updateprofile" action="#">
	    				<input type="hidden" name="c_admin" value="<?php echo $hadmin->c_admin; ?>">
	    				<div class="form-group">
	    					<label>NAMA</label>
	    					<input class="form-control" type="text" name="nama" value="<?php echo $hadmin->nama; ?>">
	    				</div>
	    			</form>
	    		</div>
	    	</div>
...
<script type="text/javascript">
    ...
    function gantipassword(){
      $.ajax({
        url : "<?php echo base_url(); ?>admin/gantipassword",
        type: "POST",
