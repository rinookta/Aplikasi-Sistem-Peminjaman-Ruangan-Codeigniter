	...
	<section class="content">
		<div class="box box-info">
			<div class="box-header with-border">
                ...
                <span class="pull-right"><a class="btn btn-xs bg-blue" target="_blank" href="<?php echo base_url('admin/export/pertanggal/'.$mulai.'/'.$sampai); ?>"><i class="fa fa-print"></i> Export</a></span>
			</div>
			<div class="box-body table-responsive">
                ...
                <tbody>
                	<?php $allpeng= $this->M_admin->pertanggal($mulai,$sampai); $vr=1; foreach($allpeng as $hallpeng){ ?>
                	<tr>
                		<td><?php echo $vr; ?></td>
