...
<?php $status= $this->uri->segment(3); if($this->uri->segment(3)=='norespon'){$statusnya= '';}else{ $statusnya=$status;} ?>
	...
	<section class="content">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title"><i class="fa fa-external-link"></i> Pengajuan Dengan Status <span style="text-transform: uppercase;"><?php echo $status; ?></span></h3>
                <span class="pull-right"><a class="btn btn-xs bg-blue" target="_blank" href="<?php echo base_url('pimpinan/export/perstatus/'.$statusnya); ?>"><i class="fa fa-print"></i> Export</a></span>
			</div>
			<div class="box-body table-responsive">
                ...
                <tbody>
                	<?php $allpeng= $this->M_pimpinan->perstatus($statusnya); $vr=1; foreach($allpeng as $hallpeng){ ?>
                	<tr>
                		<td><?php echo $vr; ?></td>
