...
<?php $mulai= $this->uri->segment(3); $sampai= $this->uri->segment(4);  ?>
	...
	<section class="content">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title"><i class="fa fa-external-link"></i> Pengajuan Tanggal <?php echo tgl($mulai); ?> Sampai <?php echo tgl($sampai); ?></h3>
                <span class="pull-right"><a class="btn btn-xs bg-blue" target="_blank" href="<?php echo base_url('pimpinan/export/pertanggal/'.$mulai.'/'.$sampai); ?>"><i class="fa fa-print"></i> Export</a></span>
			</div>
			<div class="box-body table-responsive">
                ...
                <tbody>
                	<?php $allpeng= $this->M_pimpinan->pertanggal($mulai,$sampai); $vr=1; foreach($allpeng as $hallpeng){ ?>
                	<tr>
                		<td><?php echo $vr; ?></td>
